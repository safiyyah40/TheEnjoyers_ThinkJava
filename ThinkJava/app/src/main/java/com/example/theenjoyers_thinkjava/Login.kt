...
class Login : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Asumsi ada tombol atau cara untuk pergi ke RegisterUsername, jika tidak ada, Anda bisa tambahkan.
        // val registerButton = findViewById<Button>(R.id.buttonRegister)
        // registerButton.setOnClickListener { startActivity(Intent(this, RegisterUsername::class.java)) }
                                    ...
                                    .addOnSuccessListener { document ->
                                        if (document != null && document.exists()) {
                                            ...
                                            if (username != null) {
                                                ...
                                                // PENTING: Kirim username ke MenuUtama dengan kunci "username"
